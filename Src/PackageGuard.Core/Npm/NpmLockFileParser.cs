...
internal class NpmLockFileParser
{
    ...
    /// </summary>
    /// <param name="lockFilePath">The full path to the package-lock.json file.</param>
    /// <param name="packages">The collection to populate with package information.</param>
    public async Task CollectPackageMetadata(ChainablePath lockFilePath, PackageInfoCollection packages)
    {
        NpmPackageLock? lockFile = LoadPackageLockFile(lockFilePath);
