...
public class PnpmLockFileLoaderSpecs
{
    ...
    public async Task Can_collect_package_metadata_from_pnpm_lock_file()
    {
        ...
        // Act
        await loader.CollectPackageMetadata(pnpmLockPath, projectPath, packages);
    ...
    public async Task Handles_nonexistent_pnpm_lock_file_gracefully()
    {
        ...
        // Act
        await loader.CollectPackageMetadata("/nonexistent/pnpm-lock.yaml", "/some/project", packages);
